    ...
    return (
        <>
            ...
            <Carousel responsive={responsive} className="p-4">
                <div>
                    <Link style={{ width: "20rem" }} href="/Products/All/Happiness" >
                        <a>
                            <div style={{ width: "20rem" }} className="card card-sss d-flex align-items-center justify-content-center mx-1" >
                                <div className="img-wrapper-s"><img src="/Real-State-Book.png" className="d-block w-100" alt="..." /> </div>
                                <div style={{ width: "20rem" }} className="card-body">
                                    <h5 style={{ width: "20rem" }} className="card-title text-center">300 Real Estate Templates For Social Media</h5>
