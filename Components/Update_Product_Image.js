...
function Update_Product_Image({ Image_Update_Data }) {
    ...
    const [index] = useState(Image_Update_Data.Index);
        ...
        <>
            {
                upload ?
                    <>
                        <div className="p-4">
                            <h1 className="text-warning text-center">Please Wait Image Updating.....</h1>
                            <div className="pt-4">
                                    ...
                                    <form onSubmit={(e) => Update_Products(e)} method="post" className=" border p-4 bg-light shadow">
                                        <div className="row g-0">
                                            <div className="col-sm-12 d-flex justify-content-center">
                                                <h4 className="mb-3 text-secondary">Update Product Image And Publish Product</h4>
                                            </div>
                                        </div>
                                        <div className="row">
                                            ...
                                            <div className="col-md-12">
                                                <div className="row g-0">
                                                    <div className="col-sm-12   d-flex justify-content-center ie">
                                                        <button type="submit" className="btn btn-primary px-4 py-2 ">Update Image</button>
                                                    </div>
                                                </div>
                                            </div>
...
export default Update_Product_Image;